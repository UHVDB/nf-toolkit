process UHVDB_CLASSIFY {
    ...
    output:
    tuple val(meta), path("*.uhvdb_viruses.fna.gz")    , emit: fna_gz
    ...
    uhvdb_classify.py \\
        ...
        ${dtr_sequences} \\
        --output_fasta ${prefix}.uhvdb_viruses.fna \\
    ...
    echo "" | gzip > ${prefix}.uhvdb_viruses.fna.gz
