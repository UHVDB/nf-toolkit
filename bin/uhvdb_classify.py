...
def parse_args(args=None):
    description = "Perform UHVDB virus classification and filtering."
    epilog = "Example usage: python uhvdb_classify.py --help"
...
def main(args=None):
    ...
    if args.db_type == "":
        args.db_type = "Unspecified"

    if args.body_site == "":
        args.body_site = "Other"
    ...
    joined_w_scores = (
        joined
            ...
            .with_columns([
                ...
                pl.lit(args.db_type).alias('db_type'),
                pl.lit(args.body_site).alias('body_site'),
            ])
    )
